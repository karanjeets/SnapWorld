...
public class CameraFragment extends Fragment
     ...
     */
    private static final String TAG = "SnapWorldCamera";
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        view.findViewById(R.id.clickPhoto).setOnClickListener(this);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //mFile = new File(MediaStore.Images.Media.EXTERNAL_CONTENT_URI.toString(), "pic.jpg");
    }
